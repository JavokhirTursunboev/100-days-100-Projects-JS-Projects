...
function createBlob() {
 ...
 ${  100 - radiusFour}%`;
  ...
  document.getElementById(
    "blob"
  ).style.cssText = `border-radius: ${borderRadius}; height: ${blobHeight}px; 
  width: ${blobWidth}px`;
...
document.getElementById('copy').addEventListener('click',function() {
    ...
    document.querySelector(".copy__text").style.display = "inline-block";
    setTimeout(() => {
            document.querySelector(".copy__text").style.display =
              "none";
